...
const createGravesiteTable = async () => {
  const query = `
        CREATE TABLE IF NOT EXISTS gravesites (
            ...
            first_name VARCHAR(255) NOT NULL,   -- First name of the person
            middle_name VARCHAR(255),           -- Middle name of the person (optional)
            surname VARCHAR(255) NOT NULL,      -- Surname of the person
            date_of_birth DATE,                 -- Date of birth
            date_of_death DATE,                 -- Date of death
            lot_number VARCHAR(255),            -- Formal identifier for the grave location
