...
export default function DeleteUserModal({ isOpen, onClose, name, UserId }) {
    ...
    const handleDisable = async () => {
        ...
        try {
            await axios.delete(`${API_URL}/api/admin/delete-user`, {
                data: { userID: UserId }
            });
    ...
    return (
        <div className="disable-user-modal-overlay">
            <div className="disable-user-modal-content">
                <h2 className="disable-user-modal-title">Delete User</h2>
                <p className="disable-user-modal-text">
                    Are you sure you want to Delete this User: <strong>{name}</strong>?
                </p>
